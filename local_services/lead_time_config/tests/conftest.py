...
async def test_db():
    url = os.environ.get("DATABASE_URL", "postgresql+asyncpg://postgres:postgres@localhost:5432/lead_time_config_test")
    engine = create_async_engine(url, echo=False, poolclass=NullPool)

    from sqlmodel import SQLModel
    from src.modules.lead_time_config.models.dao import LeadTimeConfig  # noqa: F401 (registers SQLModel table metadata)
...
async def mcp_client(test_db, clean_table):
    ...
    from src.modules.lead_time_config import repo as repo_module
